function showTime() {
  ...
  const getURL = "http://localhost:3001/employee"
  ...
  const deleteURL = "http://127.0.0.1:3001/employee/7";
  ...
  const postURL = "http://127.0.0.1:3001/employee";
  const emplData = { "name": "Vinay", "salary": "200000" }
